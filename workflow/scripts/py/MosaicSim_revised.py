...
paired_list = [True]
WES_list = [snakemake.params['targeted']]

use_leaf_only = False
error_rate_list = [0.001]
clone_list = [snakemake.params['n_clones']]
...
coverage_list = [snakemake.params['coverage']]
pop_list = [8e8] #recommend to keep close to this value
num_single_cell_list = [snakemake.params['n_cells']]
...
storage_dir = os.path.dirname(snakemake.output['outdir'])
...
list_of_rates = [high_rates_list, high_rates_list, medium_rates_list, medium_rates_list, low_rates_list, low_rates_list, ultralow_rates_list, ultralow_rates_list, ultralow_rates_list, medium_rates_list, ultralow_rates_list, ultralow_rates_list]
if WES_list[0]:
    list_of_rates = [[x / 10 for x in l] for l in list_of_rates]
